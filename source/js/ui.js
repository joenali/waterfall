    ...
    if (!b.ui.version) {
        ...
        function(g, f) {
            function a(j, n, p, l) {
                ...
                function() {
                    ...
                    if (p) n -= parseFloat(b.curCSS(j, "border" + this + "Width", true)) || 0;
        ...
        b.extend(b.ui, {
            plugin: {
                ...
                call: function(g, f, a) {
                    if ((f = g.plugins[f]) && g.element[0].parentNode) for (var c = 0; c < f.length; c++) g.options[f[c][0]] && f[c][1].apply(g.element, a)
                }
            },
...
(function(b, d) {
    if (b.cleanData) {
        ...
        b.cleanData = function(f) {
            for (var a = 0, c;
            (c = f[a]) != null; a++) b(c).triggerHandler("remove");
            e(f)
        }
    } else {
        var g = b.fn.remove;
    ...
    b.widget.bridge = function(f, a) {
        b.fn[f] = function(c) {
            ...
            h ? this.each(function() {
                var n = b.data(this, f),
                p = n && b.isFunction(n[c]) ? n[c].apply(n, i) : n;
                if (p !== n && p !== d) {
                    j = p;
                    return false
                }
    ...
    b.widget("ui.mouse", {
        ...
        _mouseDown: function(d) {
            ...
            if (!d.originalEvent.mouseHandled) {
                ...
                var e = this,
                g = d.which == 1,
                f = typeof this.options.cancel == "string" ? b(d.target).parents().add(d.target).filter(this.options.cancel).length: false;
...
(function(b) {
    b.widget("ui.draggable", b.ui.mouse, {
        ...
        _convertPositionTo: function(d, e) {
            ...
            return {
                top: e.top + this.offset.relative.top * d + this.offset.parent.top * d - (b.browser.safari && b.browser.version < 526 && this.cssPosition == "fixed" ? 0 : (this.cssPosition == "fixed" ? -this.scrollParent.scrollTop() : f ? 0 : g.scrollTop()) * d),
    ...
    b.ui.plugin.add("draggable", "scroll", {
        ...
        drag: function(d) {
            ...
            if (e.scrollParent[0] != document && e.scrollParent[0].tagName != "HTML") {
                ...
                else if (d.pageY - e.overflowOffset.top < g.scrollSensitivity) e.scrollParent[0].scrollTop = f = e.scrollParent[0].scrollTop - g.scrollSpeed;
                ...
                else if (b(window).height() - (d.pageY - b(document).scrollTop()) < g.scrollSensitivity) f = b(document).scrollTop(b(document).scrollTop() + g.scrollSpeed);
    ...
    b.ui.plugin.add("draggable", "snap", {
        ...
        drag: function(d, e) {
            for (var g = b(this).data("draggable"), f = g.options, a = f.snapTolerance, c = e.offset.left, h = c + g.helperProportions.width, i = e.offset.top, j = i + g.helperProportions.height, n = g.snapElements.length - 1; n >= 0; n--) {
                var p = g.snapElements[n].left,
                l = p + g.snapElements[n].width,
                ...
                if (p - a < c && c < l + a && k - a < i && i < m + a || p - a < c && c < l + a && k - a < j && j < m + a || p - a < h && h < l + a && k - a < i && i < m + a || p - a < h && h < l + a && k - a < j && j < m + a) {
                    if (f.snapMode != "inner") {
                        ...
                        if (q) e.position.top = g._convertPositionTo("relative", {
                            top: m,
                            left: 0
                        }).top - g.margins.top;
...
(function(b) {
    b.widget("ui.resizable", b.ui.mouse, {
            ...
            this._renderAxis = function(j) {
                ...
                for (var n in this.handles) {
                    ...
                    if (this.elementIsWrapper && this.originalElement[0].nodeName.match(/textarea|input|select|button/i)) {
                        var p = b(this.handles[n], this.element),
                        l = 0;
        ...
        _mouseCapture: function(g) {
            var f = false;
            for (var a in this.handles) if (b(this.handles[a])[0] == g.target) f = true;
        ...
        _respectSize: function(g) {
            ...
            if (j && a) g.top = p - f.minHeight;
            if (h && a) g.top = p - f.maxHeight;
        ...
        _proportionallyResize: function() {
            if (this._proportionallyResizeElements.length) for (var g = this.helper || this.element, f = 0; f < this._proportionallyResizeElements.length; f++) {
                ...
                if (!this.borderDif) {
                    var c = [a.css("borderTopWidth"), a.css("borderRightWidth"), a.css("borderBottomWidth"), a.css("borderLeftWidth")],
                    h = [a.css("paddingTop"), a.css("paddingRight"), a.css("paddingBottom"), a.css("paddingLeft")];
                    this.borderDif = b.map(c,
                    function(i, j) {
                        i = parseInt(i, 10) || 0;
                        j = parseInt(h[j], 10) || 0;
                        return i + j
        ...
        resize: function(g, f) {
            ...
            j = function(n, p) {
                b(n).each(function() {
                    ...
                    m = {},
                    o = p && p.length ? p: l.parents(f.originalElement[0]).length ? ["width", "height"] : ["width", "height", "top", "left"];
                    b.each(o,
                    function(q, s) {
    ...
    b.ui.plugin.add("resizable", "containment", {
        ...
        stop: function() {
            ...
            g._helper && !f.animate && /static/.test(h.css("position")) && b(this).css({
                left: j.left - c.left - a.left,
                width: n,
                height: i
            })
...
(function(b) {
    b.widget("ui.sortable", b.ui.mouse, {
        ...
        _mouseDrag: function(d) {
            ...
            if (this.options.scroll) {
                ...
                if (this.scrollParent[0] != document && this.scrollParent[0].tagName != "HTML") {
                    ...
                    if (this.overflowOffset.left + this.scrollParent[0].offsetWidth - d.pageX < e.scrollSensitivity) this.scrollParent[0].scrollLeft = g = this.scrollParent[0].scrollLeft + e.scrollSpeed;
                    ...
                    else if (b(window).height() - (d.pageY - b(document).scrollTop()) < e.scrollSensitivity) g = b(document).scrollTop(b(document).scrollTop() + e.scrollSpeed);
        ...
        _refreshItems: function(d) {
            ...
            var e = this.items,
            g = [[b.isFunction(this.options.items) ? this.options.items.call(this.element[0], d, {
                item: this.currentItem
            }) : b(this.options.items, this.element), this]],
            f = this._connectWith();
            if (f) for (var a = f.length - 1; a >= 0; a--) for (var c = b(f[a]), h = c.length - 1; h >= 0; h--) {
        ...
        _convertPositionTo: function(d, e) {
            ...
            return {
                ...
                left: e.left + this.offset.relative.left * d + this.offset.parent.left * d - (b.browser.safari && this.cssPosition == "fixed" ? 0 : (this.cssPosition == "fixed" ? -this.scrollParent.scrollLeft() : f ? 0 : g.scrollLeft()) * d)
            }
        },
        _generatePosition: function(d) {
            var e = this.options,
            ...
            return {
                top: c - this.offset.click.top - this.offset.relative.top - this.offset.parent.top + (b.browser.safari && this.cssPosition == "fixed" ? 0 : this.cssPosition == "fixed" ? -this.scrollParent.scrollTop() : f ? 0 : g.scrollTop()),
...
function(b, d) {
    ...
    function a(l) {
        ...
        for (k in l) {
            m = l[k];
            if (m == null || b.isFunction(m) || k in p || /scrollbar/.test(k) || !/color/i.test(k) && isNaN(parseFloat(m))) delete l[k]
        }
        return l
    }
    function c(l, k) {
    ...
    b.fn.extend({
        ...
        toggleClass: function(l, k, m, o, q) {
            ...
            m, o, q]) : this._toggleClass(l, k) : b.effects.animateClass.apply(this, [{
                toggle: l
            },
            k, m, o])
        },
    ...
    b.extend(b.easing, {
        ...
        easeInOutQuart: function(l, k, m, o, q) {
            if ((k /= q / 2) < 1) return o / 2 * k * k * k * k + m;
        ...
        easeInOutQuint: function(l, k, m, o, q) {
            if ((k /= q / 2) < 1) return o / 2 * k * k * k * k * k + m;
        ...
        easeInOutExpo: function(l, k, m, o, q) {
            if (k == 0) return m;
            if (k == q) return m + o;
            if ((k /= q / 2) < 1) return o / 2 * Math.pow(2, 10 * (k - 1)) + m;
        ...
        easeInOutCirc: function(l, k, m, o, q) {
            if ((k /= q / 2) < 1) return - o / 2 * (Math.sqrt(1 - k * k) - 1) + m;
        ...
        easeInOutBack: function(l, k, m, o, q, s) {
            if (s == d) s = 1.70158;
            if ((k /= q / 2) < 1) return o / 2 * k * k * (((s *= 1.525) + 1) * k - s) + m;
        ...
        easeInOutBounce: function(l, k, m, o, q) {
            if (k < q / 2) return b.easing.easeInBounce(l, k * 2, 0, o, q) * 0.5 + m;
...
(function(b) {
    b.effects.blind = function(d) {
        return this.queue(function() {
            ...
            var i = {};
            i[h] = f == "show" ? a: 0;
            c.animate(i, d.duration, d.options.easing,
            function() {
                f == "hide" && e.hide();
...
(function(b) {
    b.effects.explode = function(d) {
        return this.queue(function() {
            ...
            for (var c = f.outerWidth(true), h = f.outerHeight(true), i = 0; i < e; i++) for (var j = 0; j < g; j++) f.clone().appendTo("body").wrap("<div></div>").css({
                position: "absolute",
                visibility: "visible",
                left: -j * (c / g),
                top: -i * (h / e)
                ...
                top: a.top + i * (h / e) + (d.options.mode == "show" ? 0 : (i - Math.floor(e / 2)) * (h / e)),
...
(function(b) {
    b.effects.fold = function(d) {
        return this.queue(function() {
            ...
            var p = /([0-9]+)%/.exec(a);
            if (p) a = parseInt(p[1], 10) / 100 * j[f == "hide" ? 0 : 1];
            if (f == "show") i.css(c ? {
                height: 0,
                width: a
            }: {
            ...
            c[n[0]] = f == "show" ? j[0] : a;
            p[n[1]] = f == "show" ? j[1] : 0;
            i.animate(c, h, d.options.easing).animate(p, h, d.options.easing,
            function() {
                f == "hide" && e.hide();
                b.effects.restore(e, g);
                b.effects.removeWrapper(e);
...
(function(b) {
    ...
    b.effects.scale = function(d) {
        return this.queue(function() {
            ...
            d.options),
            f = b.effects.setMode(e, d.options.mode || "effect"),
            a = parseInt(d.options.percent, 10) || (parseInt(d.options.percent, 10) == 0 ? 0 : f == "hide" ? 0 : 100),
...
(function(b) {
    b.effects.shake = function(d) {
        return this.queue(function() {
            ...
            for (a = 1; a < c; a++) e.animate(n, h, d.options.easing).animate(p, h, d.options.easing);
            e.animate(n, h, d.options.easing).animate(f, h / 2, d.options.easing,
            function() {
                b.effects.restore(e, g);
                b.effects.removeWrapper(e);
                d.callback && d.callback.apply(this, arguments)
    ...
    b.effects.transfer = function(d) {
        return this.queue(function() {
            ...
            var a = b('<div class="ui-effects-transfer"></div>').appendTo(document.body).addClass(d.options.className).css({
                ...
                width: e.innerWidth(),
                position: "absolute"
            }).animate(g, d.duration, d.options.easing,
            function() {
                a.remove();
                d.callback && d.callback.apply(e[0], arguments);
                e.dequeue()
...
(function(b) {
    b.widget("ui.accordion", {
        ...
        _create: function() {
            ...
            e.event && d.headers.bind(e.event.split(" ").join(".accordion ") + ".accordion",
            function(a) {
...
(function(b) {
    ...
    b.widget("ui.button", {
        ...
        _create: function() {
            ...
            c && this.element.bind("change.button",
            function() {
                f.refresh()
            });
        ...
        _determineButtonType: function() {
            ...
            if (this.type === "checkbox" || this.type === "radio") {
                ...
                if (!this.buttonElement.length) {
                    ...
                    if (!this.buttonElement.length) this.buttonElement = f.find(a)
                }
        ...
        _resetButton: function() {
            if (this.type === "input") this.options.label && this.element.val(this.options.label);
                ...
                a = b("<span></span>").addClass("ui-button-text").html(this.options.label).appendTo(f.empty()).text(),
...
(function(b, d) {
    ...
    b.extend(e.prototype, {
        ...
        _attachDatepicker: function(a, c) {
            ...
            c || {},
            h || {});
            if (i == "input") this._connectDatepicker(a, p);
            else j && this._inlineDatepicker(a, p)
        },
        ...
        _optionDatepicker: function(a, c, h) {
            ...
            if (arguments.length == 2 && typeof c == "string") return c == "defaults" ? b.extend({},
            ...
            if (i) {
                ...
                p = this._getMinMaxDate(i, "min"),
                l = this._getMinMaxDate(i, "max");
                g(i.settings, j);
                if (p !== null && j.dateFormat !== d && j.minDate === d) i.settings.minDate = this._formatDate(i, p);
        ...
        _getDateDatepicker: function(a, c) { (a = this._getInst(a)) && !a.inline && this._setDateFromField(a, c);
        ...
        _checkOffset: function(a, c, h) {
            ...
            p = a.input ? a.input.outerHeight() : 0,
        ...
        parseDate: function(a, c, h) {
            ...
            for (var j = (h ? h.dayNamesShort: null) || this._defaults.dayNamesShort, n = (h ? h.dayNames: null) || this._defaults.dayNames, p = (h ? h.monthNamesShort: null) || this._defaults.monthNamesShort, l = (h ? h.monthNames: null) || this._defaults.monthNames, k = h = -1, m = -1, o = -1, q = false, s = function(x) { (x = y + 1 < a.length && a.charAt(y + 1) == x) && y++;
                return x
            },
            r = function(x) {
                var C = s(x);
        ...
        formatDate: function(a, c, h) {
            ...
            var p = function(s) { (s = q + 1 < a.length && a.charAt(q + 1) == s) && q++;
                return s
            },
            l = function(s, r, u) {
                r = "" + r;
        ...
        _possibleChars: function(a) {
            for (var c = "", h = false, i = function(n) { (n = j + 1 < a.length && a.charAt(j + 1) == n) && j++;
                return n
            },
                ...
                for (var N = "", H = 0; H < p[1]; H++) {
                    ...
                    if (m) {
                        ...
                        case 0:
                            ...
                            break;
                        case p[1] - 1 : D += " ui-datepicker-group-last";
    ...
    b.fn.datepicker = function(a) {
        ...
        if (a == "option" && arguments.length == 2 && typeof arguments[1] == "string") return b.datepicker["_" + a + "Datepicker"].apply(b.datepicker, [this[0]].concat(c));
        return this.each(function() {
...
(function(b, d) {
    ...
    b.widget("ui.dialog", {
        ...
        _create: function() {
            ...
            i = (f.uiDialog = b("<div></div>")).appendTo(document.body).hide().addClass("ui-dialog ui-widget ui-widget-content ui-corner-all " + a.dialogClass).css({
                zIndex: a.zIndex
            ...
            var j = (f.uiDialogTitlebar = b("<div></div>")).addClass("ui-dialog-titlebar ui-widget-header ui-corner-all ui-helper-clearfix").prependTo(i),
        ...
        close: function(f) {
            ...
            if (false !== a._trigger("beforeClose", f)) {
                ...
                a._isOpen = false;
                if (a.options.hide) a.uiDialog.hide(a.options.hide,
                function() {
                    a._trigger("close", f)
                });
                else {
        ...
        open: function() {
            if (!this._isOpen) {
                ...
                c.show(a.show);
                f.moveToTop(true);
                a.modal && c.bind("keypress.ui-dialog",
                function(h) {
        ...
        _setOption: function(f, a) {
            ...
            case "draggable":
                ...
                i && !a && h.draggable("destroy"); ! i && a && c._makeDraggable();
                break;
            case "position":
                c._position(a);
                break;
            case "resizable":
                ...
                i && typeof a === "string" && h.resizable("option", "handles", a); ! i && a !== false && c._makeResizable(a);
                break;
            case "title":
        ...
        _size: function() {
            var f = this.options,
            a, c, h = this.uiDialog.is(":visible");
        ...
        flip: {
            left: function(a, c) {
                if (c.at[0] !== "center") {
                    var h = b(window);
                    h = c.collisionPosition.left + c.collisionWidth - h.width() - h.scrollLeft();
                    var i = c.my[0] === "left" ? -c.elemWidth: c.my[0] === "right" ? c.elemWidth: 0,
            ...
            top: function(a, c) {
                if (c.at[1] !== "center") {
                    var h = b(window);
                    h = c.collisionPosition.top + c.collisionHeight - h.height() - h.scrollTop();
                    var i = c.my[1] === "top" ? -c.elemHeight: c.my[1] === "bottom" ? c.elemHeight: 0,
    ...
    b.widget("ui.slider", b.ui.mouse, {
        ...
        _refreshValue: function() {
            ...
            if (this.options.values && this.options.values.length) this.handles.each(function(p) {
                ...
                if (d === "min" && this.orientation === "horizontal") this.range.stop(1, 1)[f ? "animate": "css"]({
                    width: a + "%"
                },
                e.animate);
...
(function(b, d) {
    ...
    b.widget("ui.tabs", {
        ...
        _tabify: function(c) {
            ...
            if (c) {
                ...
                j.disabled = b.unique(j.disabled.concat(b.map(this.lis.filter(".ui-state-disabled"),
                function(r) {
            ...
            c = 0;
            for (var p; p = this.lis[c]; c++) b(p)[b.inArray(c, j.disabled) != -1 && !b(p).hasClass("ui-tabs-selected") ? "addClass": "removeClass"]("ui-state-disabled");
        ...
        remove: function(c) {
            ...
            h.disabled = b.map(b.grep(h.disabled,
            function(n) {
                return n != c
            }),
            function(n) {
    ...
    b.extend(b.ui.tabs.prototype, {
        ...
        rotate: function(c, h) {
            var i = this,
            j = this.options,
            n = i._rotate || (i._rotate = function(p) {
